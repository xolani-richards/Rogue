...
public class Stats {
    ...
    public float StaminaRecovery => GetStat(StatType.StaminaRecovery, baseStats.staminaRecovery, out staminaRecovery);
    ...
    public override string ToString() => $"DMG: {MeleeAttack}, DEF: {MeleeDefense}, MDMG: {MagicAttack}, MDEF: {magicDefense}, STR: {StaminaRecovery}";
}